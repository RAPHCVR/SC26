...
export function autoLayout(nodes) {
  ...
  const eventSpacing = 50; // Horizontal spacing between event nodes within a period.
  const elementSpacing = 20; // Vertical spacing between element nodes within an event.
